...
CREATE OR REPLACE TRIGGER addBitacora6
AFTER INSERT ON chat FOR EACH ROW
BEGIN 
INSERT INTO Bitacora (email,fecha,descripcion) VALUES ((SELECT U.email FROM usuario U WHERE U.idUsuario=:new.idUsuario2),LOCALTIMESTAMP(2), 'Este usuario inicio un chat ');
END addBitacora6;
